...
> ⛔ **เอกสารนี้ล้าสมัยแล้ว — อย่าใช้อ้างอิง**
> เขียนก่อนทราบว่าสลากธนโชคปิดการขายแล้ว และก่อนทราบว่าระบบ Production ที่ใช้อยู่จริง
> ยังเป็น Windows + MS SQL (เอกสารนี้อธิบายเฉพาะแพลตฟอร์มปลายทาง Docker/PostgreSQL)
> **ใช้ `tanachok-system-review.md` แทน** — เก็บไฟล์นี้ไว้เพื่อการอ้างอิงย้อนหลังเท่านั้น
